...
dataset_id = 'ds_nif_raw_level'

#sql conn detail
# JDBC connection details
jdbc_url = "jdbc:sqlserver://172.35.30.7:1433;databaseName=NIF;encrypt=false"
...
# csv file path
csv_file_path = './data_folder/Listado de Tablas - NIF.csv'
...
if os.path.exists('sql_table_names_nif.txt'):
    os.remove('sql_table_names_nif.txt')
...
for table_name in table_names:
    ...
    bq_table_name = f'nif_{table_name}'
    ...
    with open('sql_table_names_nif.txt', 'a') as file:  # Open in append mode
