...
# csv file path
csv_file_path = './data_folder/Listado de Tablas - PEA.csv'
...
if os.path.exists('sql_table_names_pea.txt'):
    os.remove('sql_table_names_pea.txt')
...
for table_name in table_names:
    ...
    bq_table_name = f'pea_{table_name}'
    ...
    with open('sql_table_names_pea.txt', 'a') as file:  # Open in append mode
