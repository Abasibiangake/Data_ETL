...
def create_table_if_not_exists(project_id, dataset_id, table_name, schema):
    ...
    # Add the new column "LASTDATE" to the schema
...
dataset_id = 'ds_pmo_raw_level'

#sql conn detail
# JDBC connection details
jdbc_url = "jdbc:sqlserver://172.35.30.7:1433;databaseName=PMO-ORACARGA-IN;encrypt=false"
...
# csv file path
csv_file_path = './data_folder/Listado de Tablas - PMO.csv'
...
if os.path.exists('sql_table_names_pmo.txt'):
    os.remove('sql_table_names_pmo.txt')
...
for table_name in table_names:
    ...
    bq_table_name = f'pmo_{table_name}'
    ...
    with open('sql_table_names_pmo.txt', 'a') as file:  # Open in append mode
